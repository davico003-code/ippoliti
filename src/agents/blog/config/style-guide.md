...
## Frases marca (usar con naturalidad)
...
- Rangos por barrio con valores: Funes Lakes USD 80K, Vida USD 170K, Funes Hills USD 220K, Kentucky USD 350K.
...
- Crítica a otras inmobiliarias o desarrolladores
- Política partidaria, nombres de políticos actuales
- Predicciones categóricas dólar/inflación
- Crypto, blockchain, tokenización
- Emojis en el cuerpo (sí moderados en cierre/CTA)

## Cierre
Rotar entre 3 CTAs (ver ctas.ts): web, instagram, whatsapp.

## Largo óptimo
800-1200 palabras. Párrafos max 4 líneas. Subtítulos cada 150-200 palabras.

## Tipos de tema preferidos
- Análisis de coyuntura (blanqueo, créditos, CAC, dólar aplicado a local)
- Comparaciones ABC1 (Funes vs Rosario, barrio vs barrio)
- Guías prácticas (cómo comprar, tasar, invertir)
...
- 40+ años de trayectoria sin soberbia
