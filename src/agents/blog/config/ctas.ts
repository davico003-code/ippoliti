...
export const CTAS: CTA[] = [
  ...
  },
  {
    id: 'whatsapp',
    texto:
      'En SI INMOBILIARIA trabajamos todos los días con personas evaluando cómo invertir mejor su capital. Consultanos por WhatsApp al +54 341 334-0916 o visitá siinmobiliaria.com.',
    tono: 'directo',
  },
];
