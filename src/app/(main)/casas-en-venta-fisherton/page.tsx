...
import { getProperties, type TokkoProperty, getMainPhoto, formatPrice, generatePropertySlug, getSuperficieCubiertaTotal } from '@/lib/tokko'
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 px-4">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {properties.map(p => { const photo = getMainPhoto(p); const roofed = getSuperficieCubiertaTotal(p); const beds = p.suite_amount || p.room_amount; return (
