...
const TIERS: TierGroup[] = [
  ...
  },
  {
    ...
    barrios: [
      { slug: 'aguadas',        nombre: 'Aguadas',        descripcion: 'Información próximamente', meta1: '', meta2: '', lat: -32.9445, lng: -60.8460 },
      { slug: 'la-finca-1',     nombre: 'La Finca 1',     descripcion: 'Información próximamente', meta1: '', meta2: '', lat: -32.9380, lng: -60.8060 },
      { slug: 'haras-de-funes', nombre: 'Haras de Funes', descripcion: 'Información próximamente', meta1: '', meta2: '', lat: -32.9525, lng: -60.8305 },
      { slug: 'la-finca-2',     nombre: 'La Finca 2',     descripcion: 'Información próximamente', meta1: '', meta2: '', lat: -32.9415, lng: -60.8015 },
    ],
  },
]
...
const MAPA_LEYENDA: { tier: HubTier; label: string; color: string }[] = [
  ...
  { tier: 'proximamente', label: 'Próximamente', color: '#0A0A0A' },
]
