...
//
// Las imágenes en /public/placas/ pueden no existir aún; cuando no carguen,
// PlacaEditorial cae al fallbackGradient (CSS) para mantener composición.
...
export interface PlacaEditorial {
  ...
  cta: string;
  href: string;
  imagen: string;             // ej. "/placas/funes-lakes.webp"
  fallbackGradient: string;   // CSS gradient si imagen falla / no existe
}
...
export const PLACAS_EDITORIALES: PlacaEditorial[] = [
  {
    ...
    imagen: "/placas/funes-lakes.webp",
    fallbackGradient:
  ...
  },
  {
    ...
    imagen: "/placas/vida-lagoon.webp",
    fallbackGradient:
