  ...
  return (
    <div className="min-h-screen bg-white">
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Alquileres en Roldán', url: 'https://siinmobiliaria.com/alquiler-roldan' },
      ]} />
      {/* Hero */}
      ...
      <section className="py-16 px-4 bg-white text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          {/* Alquileres de Roldán → Leticia (agente de alquileres), pedido de David 11-sep. */}
          <a href="https://wa.me/5493413415159?text=Hola!%20Quiero%20consultar%20por%20administración%20de%20alquiler" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-green-500 hover:bg-green-600 text-white font-bold rounded-lg transition-colors">
