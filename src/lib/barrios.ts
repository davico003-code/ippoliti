...
export const BARRIOS: Barrio[] = [
  // -------------------------------------------------------
  {
    ...
    amenities: [
      { id: "seguridad-24", label: "Seguridad privada 24hs", icon: ICON.seguridad },
      { id: "doble-ingreso", label: "Doble ingreso vehicular", icon: ICON.seguridad },
      ...
      { id: "piscinas", label: "Piscinas", icon: ICON.pileta },
      { id: "quinchos", label: "Quinchos", icon: ICON.quincho },
      { id: "gimnasio", label: "Gimnasio", icon: ICON.gym },
  ...
  // -------------------------------------------------------
  {
    ...
    amenities: [
      { id: "seguridad-24", label: "Seguridad privada 24hs", icon: ICON.seguridad },
      { id: "laguna", label: "Laguna", icon: ICON.laguna },
      { id: "playa", label: "Playa", icon: ICON.playa },
      { id: "servicios-playa", label: "Servicios de playa", icon: ICON.playa },
      ...
      { id: "areas-recreativas", label: "Áreas recreativas", icon: ICON.parquizado },
      { id: "quinchos", label: "Quinchos", icon: ICON.quincho },
      { id: "bar", label: "Bar / Restaurante", icon: ICON.bar },
      { id: "futbol", label: "Cancha de fútbol", icon: ICON.futbol },
      { id: "tenis", label: "Canchas de tenis", icon: ICON.tenis },
  ...
  // -------------------------------------------------------
  {
    ...
    amenities: [
      { id: "areas-deportivas", label: "Áreas deportivas", icon: ICON.gym },
      { id: "areas-recreativas", label: "Áreas recreativas", icon: ICON.parquizado },
      { id: "solarium", label: "Solárium con mobiliario", icon: ICON.playa },
      { id: "tenis", label: "Canchas de tenis", icon: ICON.tenis },
      { id: "futbol", label: "Cancha de fútbol", icon: ICON.futbol },
