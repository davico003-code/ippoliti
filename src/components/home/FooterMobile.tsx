  ...
  return (
    <footer className="relative bg-neutral-950 text-white">
      ...
      <div className="px-5 py-7 border-b border-white/10">
        <p className="font-poppins text-[10px] font-bold tracking-[0.2em] uppercase mb-4" style={{ color: GOLD }}>Seguinos</p>
            ...
            <a key={r.handle} href={r.href} target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 rounded-xl p-3.5 hover:bg-white/10 transition">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="font-poppins text-white/70 text-[10px]">{r.handle}</p>
                </div>
              </div>
            </a>
          ))}
      ...
      <div className="px-5 py-7 border-b border-white/10">
        <div className="grid grid-cols-2 gap-x-5 gap-y-7">
          <div>
            <p className="font-poppins text-[10px] font-bold tracking-[0.2em] uppercase mb-3" style={{ color: GOLD }}>Propiedades</p>
          ...
          <div>
            <p className="font-poppins text-[10px] font-bold tracking-[0.2em] uppercase mb-3" style={{ color: GOLD }}>Por zona</p>
            <ul className="space-y-2.5">
          ...
          <div>
            <p className="font-poppins text-[10px] font-bold tracking-[0.2em] uppercase mb-3" style={{ color: GOLD }}>Servicios</p>
            <ul className="space-y-2.5">
              <li><Link href="/tasaciones" className="font-poppins text-white text-[13px]">Tasaciones</Link></li>
              <li><Link href="/guia" prefetch={false} className="font-poppins text-white/80 text-[13px]">Guía del comprador</Link></li>
          ...
          <div>
            <p className="font-poppins text-[10px] font-bold tracking-[0.2em] uppercase mb-3" style={{ color: GOLD }}>Empresa</p>
            <ul className="space-y-2.5">
      ...
      {/* 4. Oficinas NAP */}
      <div className="px-5 py-7 border-b border-white/10">
        <p className="font-poppins text-[10px] font-bold tracking-[0.2em] uppercase mb-4" style={{ color: GOLD }}>Nuestras oficinas</p>
        <div className="space-y-4">
          {SEDES_FOOTER.map(s => (
            <div key={s.nombre}>
              <div className="flex items-baseline gap-2">
                <p className="font-raleway font-bold text-white text-[14px]">{s.nombre}</p>
                <p className="font-poppins text-[10px] font-bold tracking-wider" style={{ color: GOLD, fontVariantNumeric: 'tabular-nums' }}>{s.year}</p>
              </div>
              {s.extra && <p className="font-poppins text-white/85 text-[11px] italic mt-0.5">{s.extra}</p>}
              <p className="font-poppins text-white/80 text-[12px] mt-0.5">{s.direccion}</p>
              <p className="font-poppins text-white/65 text-[11px] mt-0.5">{s.horario}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="px-5 py-7">
        <Image
          ...
          style={{ height: 28, width: 'auto' }}
        />
        <p className="font-poppins text-white/80 text-[12px] mt-3 leading-relaxed">
          Inmobiliaria familiar fundada en Roldán en 1983.<br />
          Funes · Roldán · Rosario.
        </p>
        <div className="space-y-1.5 mt-5 mb-5">
          <p className="font-poppins text-white/70 text-[11px]">David Flores · Corredor Inmobiliario</p>
          <p className="font-poppins text-white/70 text-[11px]" style={{ fontVariantNumeric: 'tabular-nums' }}>Mat. N° 0621 · CCPISCRR</p>
        </div>
        <div className="flex flex-wrap gap-x-4 gap-y-2 mb-5">
          <Link href="/privacidad" className="font-poppins text-white/80 text-[11px]">Privacidad</Link>
          <Link href="/terminos" className="font-poppins text-white/80 text-[11px]">Términos</Link>
        </div>
