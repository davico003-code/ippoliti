  ...
  if (state.kind === 'loading') {
    return (
      <SectionBoundary name="similares">
        <section
          id="similares"
          className="bg-white rounded-2xl px-5 md:px-8 pt-6 pb-8 shadow-sm border border-gray-100"
          aria-busy="true"
        >
  ...
  if (state.kind === 'error') {
    return (
      <SectionBoundary name="similares">
        <section
          id="similares"
          className="bg-white rounded-2xl px-5 md:px-8 py-6 shadow-sm border border-gray-100"
        >
