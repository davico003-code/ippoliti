...
// Newsletter "Oportunidades con IA" — modal centrado con la placa de SI arriba,
...
//
// Convive con OportunidadesPopup (la card esquinera de propiedades curadas):
// esta sale recién a los 90s para el visitante que se quedó navegando, con
// dismiss propio para que ninguno pise al otro.
...
export default function NewsletterPopup() {
  ...
  return (
    <>
      ...
      <aside className="si-newsletter-popup" aria-label="Oportunidades con IA">
        <button
          type="button"
          onClick={dismiss}
          aria-label="Cerrar"
        ...
        <div className="si-newsletter-art">
          <Image
            src="/oportunidades-ia-v3.webp"
          ...
          {status === 'sent' ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-2.5">
              <div className="si-newsletter-steps" aria-label="Así seleccionamos cada oportunidad">
                ...
                <div className="si-newsletter-steps-row">
