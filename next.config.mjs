...
const nextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      // Proxies estables de oportunidades del catálogo experto. Se habilitan
      // únicamente cuando Hilo confirma derechos de reutilización.
      { protocol: 'https', hostname: 'meethilo.com' },
